  ...
  return (
    ...
    <section className="main-slider style1">
      <div className="slider-box">
        <div className="slider-contact-info-box" data-aos="slide-left" data-aos-easing="linear" data-aos-duration={1500}>
              ...
              <div className="content">
                ...
                <div className="btns-box">
                  <a className="btn-one" href="about.html">
                    <span className="txt">
                      discover more<i className="icon-refresh arrow" />
                    </span>
                  </a>
                </div>
              </div>
            ...
            <div className="about-style1__content">
              ...
              <div className="inner-content">
                ...
                <div className="row">
                  <div className="col-xl-6">
                    <div className="single-text-box">
                      <h3><span className="icon-right-arrow" />Help us Save a Life</h3>
                      <p>Nullam mollis elit quis dusto is lacinia efficitur</p>
                    </div>
                  </div>
                  <div className="col-xl-6">
                    <div className="single-text-box">
                      <h3><span className="icon-right-arrow" />Join our Big Family</h3>
                      <p>Nullam mollis elit quis dusto is lacinia efficitur</p>
                    </div>
                  </div>
                </div>
                <div className="btns-box">
                  <a className="btn-one" href="about.html">
                    <span className="txt">
                      Discover About More<i className="icon-refresh arrow" />
                    </span>
                  </a>
                </div>
              </div>
      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-xl-4 col-lg-4">
            <div className="single-service-style1 wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
              ...
              <div className="text-holder">
                ...
                <div className="btn-box">
                  <a href="services-single-1.html">Read More <span className="icon-right-arrow" /></a>
                </div>
              </div>
            </div>
          </div>
          ...
          {/*Start Single Service Style1*/}
          <div className="col-xl-4 col-lg-4">
            <div className="single-service-style1 wow fadeInDown" data-wow-delay="100ms" data-wow-duration="1500ms">
              <div className="img-holder">
              ...
              <div className="text-holder">
                ...
                <p>Lorem ipsum is simply dolor sit am adipi we help you ensure everyone.</p>
                <div className="btn-box">
                  <a href="services-single-2.html">Read More <span className="icon-right-arrow" /></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-xl-4 col-lg-4">
            <div className="single-service-style1 wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
              ...
              <div className="text-holder">
                ...
                <p>Lorem ipsum is simply dolor sit am adipi we help you ensure everyone.</p>
                <div className="btn-box">
                  <a href="services-single-3.html">Read More <span className="icon-right-arrow" /></a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-xl-12">
            <div className="testimonial-style1-content">
              ...
              <div className="theme_carousel testimonial-carousel owl-theme owl-carousel owl-nav-style-one" data-options="{
                              &quot;loop&quot;: true, 
                              &quot;margin&quot;: 0, 
                              &quot;autoheight&quot;:true, 
                              &quot;lazyload&quot;:true, 
        ...
        <div className="row">
          <div className="col-xl-12">
            <ul className="features-style2__content">
              ...
              <li className="single-features-style2" data-aos="fade-left" data-aos-easing="linear" data-aos-duration={1500}>
                <div className="icon-holder">
              ...
              {/*Start single Features Style2*/}
              <li className="single-features-style2" data-aos="fade-right" data-aos-easing="linear" data-aos-duration={1500}>
                <div className="icon-holder">
    ...
    <section className="slogan-area">
      <div className="map-box wow slideInRight" data-wow-delay="1400ms" data-wow-duration="5500ms">
    ...
    <section className="blog-style1-area">
      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-xl-4 col-lg-4">
            <div className="single-blog-style1" data-aos="fade-down" data-aos-easing="linear" data-aos-duration={1000}>
              <div className="img-holder">
          ...
          {/*Start Single Blog Style1*/}
          <div className="col-xl-4 col-lg-4">
            <div className="single-blog-style1" data-aos="fade-up" data-aos-easing="linear" data-aos-duration={1500}>
              <div className="img-holder">
