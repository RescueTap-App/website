      ...
      <div className="row">
        ...
        <div className="col-xl-4 col-lg-5 order-box-2">
          <div className="service-details__sidebar">
            <div className="view-all-service" data-aos="slide-up" data-aos-easing="linear" data-aos-duration={1000}>
            <ul className="service-pages">
                ...
                <li>
                  <a href="/App">
                    Emergency App Services <span className="icon-next-1" />
                  </a>
                </li>
              </ul>
            </div>
            <div className="service-details-contact-info" data-aos="slide-up" data-aos-easing="linear" data-aos-duration={1000}>
              <div className="sidebar-info-box-bg" style={{backgroundImage: 'url(assets/images/sidebar/sidebar-info-box-bg.jpg)'}} />
              <h3>Need Help?</h3>
              <p>Speak with a human to filling out a form? call corporate office and we will connect
                you with a team member who can help.
              </p>
              <h2><a href="tel:+50033333">+ 1- (246) 333-0089</a></h2>
            </div>
            <div className="info-download-box" data-aos="slide-up" data-aos-easing="linear" data-aos-duration={1000}>
              <ul>
                <li>
                  <div className="icon">
        ...
        <div className="col-xl-8 col-lg-7 order-box-1">
          <div className="service-details__content">
            <div className="img-box1">
              <img src="assets/images/services/service-details-5-img1.jpg" alt />
            </div>
            ...
            <div className="text-box2">
              <div className="row">
                <div className="col-xl-6">
                  <div className="text-box2-single" data-aos="fade-right" data-aos-easing="linear" data-aos-duration={2500}>
                    <h4>
                      <span className="icon-right-arrow" /> Help us Save a Life
                    </h4>
                    <p>Nullam mollis elit quis dusto is lacinia efficitur</p>
                  </div>
                </div>
                <div className="col-xl-6">
                  <div className="text-box2-single" data-aos="fade-left" data-aos-easing="linear" data-aos-duration={2500}>
                    <h4>
                      <span className="icon-right-arrow" /> Join our Big Family
                    </h4>
                    <p>Nullam mollis elit quis dusto is lacinia efficitur</p>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-xl-6">
                  <div className="content-box">
                    ...
                    <ul>
                      <li>
                        <span className="icon-checked" /> In id diam nec nisi
                        congue tincidunt
                      </li>
                      <li>
                        <span className="icon-checked" /> Pn malesuada purus a ligula
                        dapibus
                      </li>
                      <li>
                        <span className="icon-checked" /> Vestibulum tincidunt arcu vel
                        nisl
                      </li>
                      <li>
                        <span className="icon-checked" /> Sed tristique lorem non
                        tesque
                      </li>
                    </ul>
                  </div>
